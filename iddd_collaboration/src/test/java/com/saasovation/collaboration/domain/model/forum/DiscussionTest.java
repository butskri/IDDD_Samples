...
public class DiscussionTest extends AbstractForumTest {
	...
	public void testPostToDiscussion() throws Exception {
		...
		post = discussion.post(DomainRegistry.forumIdentityService(), new Author("jdoe", "John Doe", "jdoe@saasovation.com"),
				"All About DDD", "I'd like to start a discussion all about doing domain-driven design.");
	...
	public void testMultiplePostsToDiscussion() throws Exception {
		...
		DomainEventPublisher.instance().subscribe(new DomainEventSubscriber<PostedToDiscussion>() {
			@Override
		...
		postAgain = discussion.post(DomainRegistry.forumIdentityService(), new Author("bobw", "Bob Williams", "bobw@saasovation.com"),
				"RE: All About DDD", "Well, I think it's a great idea!");
